...
def fetch_metadata(movieid):
        ...
        """
        req = requests.get('https://www.netflix.com/nq/website/memberapi/' + BUILD + '/metadata?movieid=' + movieid + '&drmSystem=widevine&isWatchlistEnabled=false&isShortformEnabled=false&isVolatileBillboardsEnabled=false', cookies=cookies)
        return json.loads(req.text)
...
def fetch_metadata_movie(BUILD, movieid):
        ...
        """
        if cookies == 'off':
            req = SESSION.get('https://www.netflix.com/nq/website/memberapi/' + BUILD + '/metadata?movieid=' + movieid + '&drmSystem=widevine&isWatchlistEnabled=false&isShortformEnabled=false&isVolatileBillboardsEnabled=false')
        else:
            req = requests.get('https://www.netflix.com/nq/website/memberapi/' + BUILD + '/metadata?movieid=' + movieid + '&drmSystem=widevine&isWatchlistEnabled=false&isShortformEnabled=false&isVolatileBillboardsEnabled=false', cookies=cookies)
        """
        req = requests.get('https://www.netflix.com/nq/website/memberapi/' + BUILD + '/metadata?movieid=' + movieid + '&drmSystem=widevine&isWatchlistEnabled=false&isShortformEnabled=false&isVolatileBillboardsEnabled=false', cookies=cookies)
