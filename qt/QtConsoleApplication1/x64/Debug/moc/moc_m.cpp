...
QT_MOC_LITERAL(1, 2, 1), // "s"
QT_MOC_LITERAL(2, 4, 0), // ""
QT_MOC_LITERAL(3, 5, 2) // "s3"
...
void A::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<A *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->s(); break;
        case 1: _t->s((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 2: _t->s3(); break;
        default: ;
        }
        ...
        {
            using _t = void (A::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&A::s)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (A::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&A::s)) {
                *result = 1;
                return;
            }
        ...
        {
            using _t = void (A::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&A::s3)) {
                *result = 2;
                return;
            }
        }
