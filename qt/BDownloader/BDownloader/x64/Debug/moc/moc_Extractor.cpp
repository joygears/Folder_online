...
QT_MOC_LITERAL(3, 25, 11), // "errorString"
QT_MOC_LITERAL(4, 37, 7), // "success"
QT_MOC_LITERAL(5, 45, 11), // "ugcFinished"
QT_MOC_LITERAL(6, 57, 11), // "pgcFinished"
QT_MOC_LITERAL(7, 69, 12), // "pugvFinished"
QT_MOC_LITERAL(8, 82, 12), // "liveFinished"
QT_MOC_LITERAL(9, 95, 20), // "liveActivityFinished"
QT_MOC_LITERAL(10, 116, 13) // "comicFinished"

    },
    "Extractor\0errorOccurred\0\0errorString\0"
    "success\0ugcFinished\0pgcFinished\0"
    "pugvFinished\0liveFinished\0"
    "liveActivityFinished\0comicFinished"
};
...
void Extractor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->ugcFinished(); break;
        case 3: _t->pgcFinished(); break;
        case 4: _t->pugvFinished(); break;
        case 5: _t->liveFinished(); break;
        case 6: _t->liveActivityFinished(); break;
        case 7: _t->comicFinished(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Extractor::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Extractor::errorOccurred)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Extractor::success)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Extractor::errorOccurred(const QString & _t1)
{
