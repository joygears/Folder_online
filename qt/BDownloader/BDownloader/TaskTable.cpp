    ...
    : QTableWidget(parent)
{
    ...
    startAllAct = new QAction(QString::fromLocal8Bit("全部开始"));
    stopAllAct = new QAction(QString::fromLocal8Bit("全部暂停"));
    removeAllAct = new QAction(QString::fromLocal8Bit("全部删除"));
