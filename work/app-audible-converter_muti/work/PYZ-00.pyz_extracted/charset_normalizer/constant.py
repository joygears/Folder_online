...
# Embedded file name: charset_normalizer\constant.py
...
UNICODE_SECONDARY_RANGE_KEYWORD = [
 ...
 'Supplemental',
 'Tags']
RE_POSSIBLE_ENCODING_INDICATION = re_compile('(?:(?:encoding)|(?:charset)|(?:coding))(?:[\\:= ]{1,10})(?:[\\"\\\']?)([a-zA-Z0-9\\-_]+)(?:[\\"\\\']?)', IGNORECASE)
IANA_SUPPORTED = sorted(filter(lambda x: x.endswith('_codec') is False and x not in frozenset({'mbcs', 'rot_13', 'tactis'}), list(set(aliases.values()))))
IANA_SUPPORTED_COUNT = len(IANA_SUPPORTED)
IANA_SUPPORTED_SIMILAR = {'cp037':[
  'cp1026',
  'cp1140',
  'cp273',
  'cp500'], 
 ...
 'tis_620':[
  'iso8859_11']}
CHARDET_CORRESPONDENCE = {'iso2022_kr':'ISO-2022-KR', 
