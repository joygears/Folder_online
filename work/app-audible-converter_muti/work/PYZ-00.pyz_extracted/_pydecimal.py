...
class Decimal(object):
    ...
    def __new__(cls, value='0', context=None):
        ...
        if isinstance(value, (list, tuple)):
            ...
            elif not (isinstance(value[0], int) and value[0] in (0, 1)):
    ...
    def __neg__(self, context=None):
        ...
        if self._is_special:
            ...
            if context is None:
                context = getcontext()
        elif not self and context.rounding != ROUND_FLOOR:
            ans = self.copy_abs()
        else:
        ...
        if other is NotImplemented:
            ...
            if context is None:
                ...
                if self._is_special or other._is_special:
                    ...
                    exp = self or self._exp - other._exp
                    coeff = 0
                else:
    ...
    def log10(self, context=None):
        ...
        if self._isinfinity() == 1:
            ...
            elif self._int[0] == '1' and self._int[1:] == '0' * (len(self._int) - 1):
    ...
    def rotate(self, other, context=None):
        ...
        if context is None:
            ...
            if ans:
                ...
                if other._exp != 0:
                    return context._raise_error(InvalidOperation)
                return -context.prec <= int(other) <= context.prec or context._raise_error(InvalidOperation)
        if self._isinfinity():
            return Decimal(self)
        else:
            torot = int(other)
