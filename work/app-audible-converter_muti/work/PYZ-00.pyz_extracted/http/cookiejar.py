...
import copy, datetime, re, time, urllib.parse, urllib.request
try:
...
class CookieJar:
    ...
    def _cookie_attrs(self, cookies):
        ...
        for cookie in cookies:
            ...
            version_set = version_set or True
            if version > 0:
                attrs.append('$Version=%s' % version)
            elif cookie.value is not None and self.non_word_re.search(cookie.value) and version > 0:
