...
"""
import email.parser, email.message, http, io, os, re, socket, collections
...
class HTTPConnection:
    ...
    def putheader(self, header, *values):
        ...
        if self._HTTPConnection__state != _CS_REQ_STARTED:
            ...
            raise _is_legal_header_name(header) or ValueError('Invalid header name %r' % (header,))
        values = list(values)
