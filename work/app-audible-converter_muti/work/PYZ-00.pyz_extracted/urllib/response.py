...
class addbase(tempfile._TemporaryFileWrapper):
    __doc__ = 'Base class for addinfo and addclosehook. Is a good idea for garbage collection.'
...
class addclosehook(addbase):
    __doc__ = 'Class to add a close hook to an open file.'
...
class addinfo(addbase):
    __doc__ = 'class to add an info() method to an open file.'
...
class addinfourl(addinfo):
    __doc__ = 'class to add info() and geturl() methods to an open file.'
