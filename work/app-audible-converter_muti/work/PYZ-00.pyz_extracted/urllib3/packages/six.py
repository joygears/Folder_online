...
# Embedded file name: urllib3\packages\six.py
...
_moved_attributes = [
 ...
 MovedModule('_dummy_thread', 'dummy_thread', '_dummy_thread' if sys.version_info < (3,
                                                                                    9) else '_thread'),
...
def ensure_str(s, encoding='utf-8', errors='strict'):
    ...
    if type(s) is str:
        ...
        if PY2:
            ...
            raise isinstance(s, (text_type, binary_type)) or TypeError("not expecting type '%s'" % type(s))
        return s
