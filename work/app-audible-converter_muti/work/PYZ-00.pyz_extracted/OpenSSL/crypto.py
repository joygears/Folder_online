...
# Embedded file name: OpenSSL\crypto.py
...
from OpenSSL._util import ffi as _ffi, lib as _lib, exception_from_error_queue as _exception_from_error_queue, byte_string as _byte_string, path_bytes as _path_bytes, UNSPECIFIED as _UNSPECIFIED, text_to_bytes_and_warn as _text_to_bytes_and_warn, make_assert as _make_assert
__all__ = [
 'FILETYPE_PEM',
 'FILETYPE_ASN1',
 'FILETYPE_TEXT',
...
class X509Extension(object):
    ...
    _prefixes = {_lib.GEN_EMAIL: 'email', 
     _lib.GEN_DNS: 'DNS', 
     _lib.GEN_URI: 'URI'}
...
class X509StoreContext(object):
    ...
    def _exception_from_context(self):
        ...
        errors = [
         ...
         _ffi.string(_lib.X509_verify_cert_error_string(_lib.X509_STORE_CTX_get_error(self._store_ctx))).decode('utf-8')]
...
class _PassphraseHelper(object):
    ...
    def callback(self):
        if self._passphrase is None:
            return _ffi.NULL
        if isinstance(self._passphrase, bytes) or callable(self._passphrase):
...
load_pkcs7_data = utils.deprecated(load_pkcs7_data, __name__, 'PKCS#7 support in pyOpenSSL is deprecated. You should use the APIs in cryptography.', DeprecationWarning)
...
load_pkcs12 = utils.deprecated(load_pkcs12, __name__, 'PKCS#12 support in pyOpenSSL is deprecated. You should use the APIs in cryptography.', DeprecationWarning)
