...
"""
import importlib._bootstrap_external, importlib.machinery, importlib.util, os, os.path, sys, traceback
__all__ = [
...
def compile(file, cfile=None, dfile=None, doraise=False, optimize=-1):
    ...
    bytecode = importlib._bootstrap_external._code_to_bytecode(code, source_stats['mtime'], source_stats['size'])
