...
from cryptography.x509.base import PRIVATE_KEY_TYPES, _EARLIEST_UTC_TIME, _convert_to_naive_utc_time, _reject_duplicate_extension
...
class OCSPRequestBuilder(object):
    ...
    def __init__(self, request: typing.Optional[typing.Tuple[(x509.Certificate, x509.Certificate, hashes.HashAlgorithm)]]=None, extensions: typing.List[x509.Extension[x509.ExtensionType]]=[]) -> None:
...
class OCSPResponseBuilder(object):
    ...
    def responder_id(self, encoding: OCSPResponderEncoding, responder_cert: x509.Certificate) -> 'OCSPResponseBuilder':
        ...
        return OCSPResponseBuilder(self._response, (
         responder_cert, encoding), self._certs, self._extensions)
    ...
    def sign(self, private_key: PRIVATE_KEY_TYPES, algorithm: typing.Optional[hashes.HashAlgorithm]) -> OCSPResponse:
        from cryptography.hazmat.backends.openssl.backend import backend
