...
from cryptography.x509.general_name import DNSName, DirectoryName, GeneralName, IPAddress, OtherName, RFC822Name, RegisteredID, UniformResourceIdentifier, _IPADDRESS_TYPES
...
class AuthorityKeyIdentifier(ExtensionType):
    ...
    def __init__(self, key_identifier: typing.Optional[bytes], authority_cert_issuer: typing.Optional[typing.Iterable[GeneralName]], authority_cert_serial_number: typing.Optional[int]) -> None:
        if (authority_cert_issuer is None) != (authority_cert_serial_number is None):
            ...
            if authority_cert_serial_number is not None:
                if not isinstance(authority_cert_serial_number, int):
    ...
    @classmethod
    def from_issuer_public_key(cls, public_key: PUBLIC_KEY_TYPES) -> 'AuthorityKeyIdentifier':
...
class SubjectKeyIdentifier(ExtensionType):
    ...
    @classmethod
    def from_public_key(cls, public_key: PUBLIC_KEY_TYPES) -> 'SubjectKeyIdentifier':
...
_REASON_BIT_MAPPING = {1:ReasonFlags.key_compromise, 
...
class PolicyInformation(object):
    ...
    @property
    def policy_qualifiers(self) -> typing.Optional[typing.List[typing.Union[(str, 'UserNotice')]]]:
...
class GeneralNames(object):
 ...
 typing.Type[RFC822Name])]) -> typing.List[str]:
        pass
    ...
    @typing.overload
    def get_values_for_type(self, type: typing.Type[IPAddress]) -> typing.List[_IPADDRESS_TYPES]:
        pass
 ...
 typing.Type[UniformResourceIdentifier])]) -> typing.Union[(
    ...
    def __init__(self, full_name: typing.Optional[typing.Iterable[GeneralName]], relative_name: typing.Optional[RelativeDistinguishedName], only_contains_user_certs: bool, only_contains_ca_certs: bool, only_some_reasons: typing.Optional[typing.FrozenSet[ReasonFlags]], indirect_crl: bool, only_contains_attribute_certs: bool) -> None:
        if full_name is not None:
            ...
            raise any([
             ...
             full_name,
             relative_name,
             only_some_reasons]) or ValueError('Cannot create empty extension: if only_contains_user_certs, only_contains_ca_certs, indirect_crl, and only_contains_attribute_certs are all False, then either full_name, relative_name, or only_some_reasons must have a value.')
