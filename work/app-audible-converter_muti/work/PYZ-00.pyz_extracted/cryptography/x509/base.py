...
def _reject_duplicate_attribute(oid: ObjectIdentifier, attributes: typing.List[typing.Tuple[(ObjectIdentifier, bytes)]]) -> None:
...
class CertificateRevocationList(metaclass=abc.ABCMeta):
    ...
    @abc.abstractmethod
    def __getitem__(self, idx: typing.Union[(int, slice)]) -> typing.Union[(RevokedCertificate, typing.List[RevokedCertificate])]:
        """
...
def load_pem_x509_csr(data: bytes, backend: typing.Optional[Backend]=None) -> CertificateSigningRequest:
    return rust_x509.load_pem_x509_csr(data)


def load_der_x509_csr(data: bytes, backend: typing.Optional[Backend]=None) -> CertificateSigningRequest:
    return rust_x509.load_der_x509_csr(data)


def load_pem_x509_crl(data: bytes, backend: typing.Optional[Backend]=None) -> CertificateRevocationList:
    return rust_x509.load_pem_x509_crl(data)


def load_der_x509_crl(data: bytes, backend: typing.Optional[Backend]=None) -> CertificateRevocationList:
    return rust_x509.load_der_x509_crl(data)


class CertificateSigningRequestBuilder(object):

    def __init__(self, subject_name: typing.Optional[Name]=None, extensions: typing.List[Extension[ExtensionType]]=[], attributes: typing.List[typing.Tuple[(ObjectIdentifier, bytes)]]=[]):
        """
    ...
    def add_attribute(self, oid: ObjectIdentifier, value: bytes) -> 'CertificateSigningRequestBuilder':
        """
    ...
    def sign(self, private_key: PRIVATE_KEY_TYPES, algorithm: typing.Optional[hashes.HashAlgorithm], backend: typing.Optional[Backend]=None) -> CertificateSigningRequest:
        """
...
class CertificateBuilder(object):
    ...
    def __init__(self, issuer_name: typing.Optional[Name]=None, subject_name: typing.Optional[Name]=None, public_key: typing.Optional[PUBLIC_KEY_TYPES]=None, serial_number: typing.Optional[int]=None, not_valid_before: typing.Optional[datetime.datetime]=None, not_valid_after: typing.Optional[datetime.datetime]=None, extensions: typing.List[Extension[ExtensionType]]=[]) -> None:
    ...
    def public_key(self, key: PUBLIC_KEY_TYPES) -> 'CertificateBuilder':
        """
        ...
        if not isinstance(key, (
         ...
         ed448.Ed448PublicKey)):
            raise TypeError('Expecting one of DSAPublicKey, RSAPublicKey, EllipticCurvePublicKey, Ed25519PublicKey or Ed448PublicKey.')
    ...
    def not_valid_before(self, time: datetime.datetime) -> 'CertificateBuilder':
        ...
        elif self._not_valid_before is not None:
    ...
    def not_valid_after(self, time: datetime.datetime) -> 'CertificateBuilder':
        ...
        if not isinstance(time, datetime.datetime):
            raise TypeError('Expecting datetime object.')
        elif self._not_valid_after is not None:
            ...
            if self._not_valid_before is not None:
                if time < self._not_valid_before:
    ...
    def sign(self, private_key: PRIVATE_KEY_TYPES, algorithm: typing.Optional[hashes.HashAlgorithm], backend: typing.Optional[Backend]=None) -> Certificate:
        """
...
class CertificateRevocationListBuilder(object):
    ...
    def last_update(self, last_update: datetime.datetime) -> 'CertificateRevocationListBuilder':
        if not isinstance(last_update, datetime.datetime):
            ...
            if self._next_update is not None:
                if last_update > self._next_update:
    ...
    def next_update(self, next_update: datetime.datetime) -> 'CertificateRevocationListBuilder':
        if not isinstance(next_update, datetime.datetime):
            raise TypeError('Expecting datetime object.')
        elif self._next_update is not None:
            raise ValueError('Last update may only be set once.')
        else:
    ...
    def sign(self, private_key: PRIVATE_KEY_TYPES, algorithm: typing.Optional[hashes.HashAlgorithm], backend: typing.Optional[Backend]=None) -> CertificateRevocationList:
        backend = _get_backend(backend)
        if self._issuer_name is None:
