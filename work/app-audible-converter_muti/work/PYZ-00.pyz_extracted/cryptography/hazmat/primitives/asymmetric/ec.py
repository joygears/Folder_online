...
def generate_private_key(curve: EllipticCurve, backend: typing.Optional[Backend]=None) -> EllipticCurvePrivateKey:
    backend = _get_backend(backend)
    return backend.generate_elliptic_curve_private_key(curve)


def derive_private_key(private_value: int, curve: EllipticCurve, backend: typing.Optional[Backend]=None) -> EllipticCurvePrivateKey:
    backend = _get_backend(backend)
...
class EllipticCurvePublicNumbers(object):
    ...
    def public_key(self, backend: typing.Optional[Backend]=None) -> EllipticCurvePublicKey:
        backend = _get_backend(backend)
...
class EllipticCurvePrivateNumbers(object):
    ...
    def private_key(self, backend: typing.Optional[Backend]=None) -> EllipticCurvePrivateKey:
        backend = _get_backend(backend)
