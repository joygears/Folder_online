...
class DSAParameterNumbers(object):
    ...
    def parameters(self, backend: typing.Optional[Backend]=None) -> DSAParameters:
...
class DSAPublicNumbers(object):
    ...
    def public_key(self, backend: typing.Optional[Backend]=None) -> DSAPublicKey:
        backend = _get_backend(backend)
...
class DSAPrivateNumbers(object):
    ...
    def private_key(self, backend: typing.Optional[Backend]=None) -> DSAPrivateKey:
        backend = _get_backend(backend)
...
def generate_parameters(key_size: int, backend: typing.Optional[Backend]=None) -> DSAParameters:
    backend = _get_backend(backend)
    return backend.generate_dsa_parameters(key_size)


def generate_private_key(key_size: int, backend: typing.Optional[Backend]=None) -> DSAPrivateKey:
    backend = _get_backend(backend)
