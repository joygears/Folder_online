    ...
    class _Section(object):
        ...
        def format_help(self):
            ...
            if not item_help:
                ...
                if self.heading is not SUPPRESS:
...
class ArgumentParser(_AttributeHolder, _ActionsContainer):
            ...
            def consume_optional(start_index):
                ...
                while True:
                    ...
                    if explicit_arg is not None:
                        ...
                        chars = self.prefix_chars
                        if arg_count == 0:
                            if option_string[1] not in chars:
                ...
                if action.required:
                    ...
                    if isinstance(action.default, str):
                        if hasattr(namespace, action.dest):
                            if action.default is getattr(namespace, action.dest):
    ...
    def _get_option_tuples(self, option_string):
        result = []
        chars = self.prefix_chars
        if option_string[0] in chars:
            if option_string[1] in chars:
                if '=' in option_string:
    ...
    def _get_values(self, action, arg_strings):
        if action.nargs not in [PARSER, REMAINDER]:
            ...
            if not arg_strings:
                if action.nargs == ZERO_OR_MORE and not action.option_strings:
                    if action.default is not None:
                        value = action.default
                    else:
                        value = arg_strings
