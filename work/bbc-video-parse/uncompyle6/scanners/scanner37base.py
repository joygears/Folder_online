...
class Scanner37Base(Scanner):
    def __init__(self, version, show_asm=None, is_pypy=False):
        ...
        if self.version < (3, 8):
            ...
            self.setup_ops_no_loop = frozenset(setup_ops) - frozenset( #获取非LOOP的启动操作码
                [self.opc.SETUP_LOOP]
            )
        else:
        ...
        self.designator_ops = frozenset( # 获取指示符操作码
            [
                self.opc.STORE_FAST,
                self.opc.STORE_NAME,
                self.opc.STORE_GLOBAL,
        ...
        self.jump_if_pop = frozenset( # 获取跳转操作码
    ...
    def ingest(self, co, classname=None, code_objects={}, show_asm=None):
        ...
        jump_targets = self.find_jump_targets(show_asm) # 获取从哪跳转到哪的信息
