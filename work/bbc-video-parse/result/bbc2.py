  # 7           0 LOAD_CONST               0 (0)
              # 2 LOAD_CONST               1 (('unicode_literals',))
              # 4 IMPORT_NAME              0 (__future__)
              # 6 IMPORT_FROM              1 (unicode_literals)
              # 8 STORE_NAME               1 (unicode_literals)
             # 10 POP_TOP
from __future__ import unicode_literals
  # 9          12 LOAD_CONST               0 (0)
             ...
             # 18 STORE_NAME               2 (re)
import re
 # 10          20 LOAD_CONST               0 (0)
             # 22 LOAD_CONST               2 (None)
             # 24 IMPORT_NAME              3 (xml.etree.ElementTree)
             # 26 STORE_NAME               4 (xml)
import xml.etree.ElementTree
 # 12          28 LOAD_CONST               3 (2)
             # 30 LOAD_CONST               4 (('InfoExtractor',))
             # 32 IMPORT_NAME              5 (extractor.common)
             # 34 IMPORT_FROM              6 (InfoExtractor)
             # 36 STORE_NAME               6 (InfoExtractor)
             # 38 POP_TOP
from ..extractor.commo import InfoExtractor
 # 13          40 LOAD_CONST               3 (2)
             # 42 LOAD_CONST               5 (('BBCCoUkIE', 'BBCIE', 'BBCCoUkArticleIE'))
             # 44 IMPORT_NAME              7 (extractor.bbc)
             # 46 IMPORT_FROM              8 (BBCCoUkIE)
             # 48 STORE_NAME               9 (OldBBCCoUkIE)
             # 50 IMPORT_FROM             10 (BBCIE)
             # 52 STORE_NAME              11 (OldBBCIE)
             # 54 IMPORT_FROM             12 (BBCCoUkArticleIE)
             # 56 STORE_NAME              13 (OldBBCCoUkArticleIE)
             # 58 POP_TOP
from ..extractor.bbc import BBCCoUkIE as OldBBCCoUkIE
from ..extractor.bbc import BBCIE as OldBBCIE
from ..extractor.bbc import BBCCoUkArticleIE as OldBBCCoUkArticleIE

 # 18          60 LOAD_CONST               3 (2)
             # 62 LOAD_CONST               6 (('ExtractorError', 'float_or_none', 'int_or_none', 'parse_duration', 'parse_iso8601', 'remove_end', 'unescapeHTML'))
             # 64 IMPORT_NAME             14 (utils)
             # 66 IMPORT_FROM             15 (ExtractorError)
             # 68 STORE_NAME              15 (ExtractorError)
             # 70 IMPORT_FROM             16 (float_or_none)
             # 72 STORE_NAME              16 (float_or_none)
             # 74 IMPORT_FROM             17 (int_or_none)
             # 76 STORE_NAME              17 (int_or_none)
             # 78 IMPORT_FROM             18 (parse_duration)
             # 80 STORE_NAME              18 (parse_duration)
             # 82 IMPORT_FROM             19 (parse_iso8601)
             # 84 STORE_NAME              19 (parse_iso8601)
             # 86 IMPORT_FROM             20 (remove_end)
             # 88 STORE_NAME              20 (remove_end)
             # 90 IMPORT_FROM             21 (unescapeHTML)
             # 92 STORE_NAME              21 (unescapeHTML)
             # 94 POP_TOP
from ..utils import ExtractorError, float_or_none, int_or_none, parse_duration, parse_iso8601, remove_end, unescapeHTML
 # 27          96 LOAD_CONST               3 (2)
             # 98 LOAD_CONST               7 (('compat_HTTPError', 'compat_urllib_parse_urlparse'))
            # 100 IMPORT_NAME             22 (compat)
            # 102 IMPORT_FROM             23 (compat_HTTPError)
            # 104 STORE_NAME              23 (compat_HTTPError)
            # 106 IMPORT_FROM             24 (compat_urllib_parse_urlparse)
            # 108 STORE_NAME              24 (compat_urllib_parse_urlparse)
            # 110 POP_TOP
from ..compat import compat_HTTPError, compat_urllib_parse_urlparse
 # 32         112 LOAD_BUILD_CLASS
            # 114 LOAD_CONST               8 (<code object BBCCoUkIE at 0x00000251229C3B70, file "C:\Users\ws\AppData\Local\Temp\tmpbn0t4kab\youtube_dl\WS_Extractor\bbc.py", line 32>)
            # 116 LOAD_CONST               9 ('BBCCoUkIE')
            # 118 MAKE_FUNCTION            0
            # 120 LOAD_CONST               9 ('BBCCoUkIE')
            # 122 LOAD_NAME                6 (InfoExtractor)
            # 124 CALL_FUNCTION            3
            # 126 STORE_NAME               8 (BBCCoUkIE)
class BBCCoUkIE(InfoExtractor):
    ...
    def _extract_connection(self, connection, programme_id):
        ...
        if protocol == 'http':
            ...
            if transfer_format == 'hls':
                ...
                #             196 CALL_METHOD              1
                #             198 POP_TOP
                self._extract_m3u8_formats(href, programme_id, ext='mp4', entry_protocol='m3u8_native',
                                           m3u8_id=programme_id, fatal=False)
                ...
                if re.search(self._USP_RE, href):
                    ...
                    usp_formats = self._extract_m3u8_formats(re.sub(self._USP_RE, '/\\1.ism/\\1.m3u8', href),
        ...
        if protocol == 'rtmp':
            ...
            #             472 POP_TOP
            formats.append(
                {'url': '%s://%s/%s?%s' % (protocol, server, application, auth_string), 'play_path': identifier,
                 'app': '%s?%s' % (application, auth_string), 'page_url': 'http://www.bbc.co.uk',
                 'player_url': 'http://www.bbc.co.uk/emp/releases/iplayer/revisions/617463_618125_4/617463_618125_4_emp.swf',
                 'rtmp_live': False, 'ext': 'flv', 'format_id': supplier})
    ...
    def _extract_medias(self, media_selection):
        ...
        return self._findall_nsmedia_selection
        './{%s}media'

    def _extract_connections(self, media):
        return self._findall_nsmedia
        './{%s}connection'
    ...
    def _download_media_selector(self, programme_id):
        ...
        for mediaselector_url in self._MEDIASELECTOR_URLS:
            try:
                ...
                formats = [item for item in formats if re.search
                'rtmp://|rtmpe://'
                formats[0]['url'] is None]
    ...
    def _process_legacy_playlist(self, playlist_id):
        return self._process_legacy_playlist_url('http://www.bbc.co.uk/iplayer/playlist/%s' % playlist_id)
        playlist_id
    ...
    def _sort_formats(self, formats):
        ...
        def _formats_key(f):
            ...
            if preference is None:
                ...
                if proto is None:
                    proto = compat_urllib_parse_urlparse(f.get
                    'url''').scheme
    ...
    def do_real_extract(self, url):
        ...
        tviplayer = self._search_regex('mediator\\.bind\\(({.+?})\\s*,\\s*document\\.getElementById',
                                       ...
                                       'player', default=None)
        if tviplayer:
            player = self._parse_jsontviplayergroup_id.get
            'player'
            {}
...
# 485         128 LOAD_BUILD_CLASS
            # 130 LOAD_CONST              10 (<code object BBCIE at 0x00000251229CA5D0, file "C:\Users\ws\AppData\Local\Temp\tmpbn0t4kab\youtube_dl\WS_Extractor\bbc.py", line 485>)
...
# 963         144 LOAD_BUILD_CLASS
            # 146 LOAD_CONST              12 (<code object BBCCoUkArticleIE at 0x00000251229CA810, file "C:\Users\ws\AppData\Local\Temp\tmpbn0t4kab\youtube_dl\WS_Extractor\bbc.py", line 963>)
...
# 999         160 LOAD_BUILD_CLASS
            # 162 LOAD_CONST              14 (<code object BBCCoUkReelVideoIE at 0x00000251229CA930, file "C:\Users\ws\AppData\Local\Temp\tmpbn0t4kab\youtube_dl\WS_Extractor\bbc.py", line 999>)
