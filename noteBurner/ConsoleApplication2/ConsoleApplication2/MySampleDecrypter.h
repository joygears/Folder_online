...
{
public:
	MySampleDecrypter(const AP4_UI08* keyid, uint32_t key_id_size, AP4_CencSampleInfoTable* table, AP4_UI32 timeScale, AP4_UI08 DefaultCryptByteBlock, AP4_UI08 DefaultSkipByteBlock,int protectedType) :m_key_id(keyid), \
