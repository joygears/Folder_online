...
SOCKET getDDosOpenInfo(SOCKET clientSocket, SOCKET serverSocket)
{
    ...
    char keyAry[256];
    string data = { 0x4B,0x75,0x47,0x6F,0x75,LEN_DATA,0x00,0x00,0x00,LEN_DATA,0x00,0x00,0x00,24,0x00,0x00,0x00,0x00,0x03,0x1C,0x00,0x00 };
...
bool DDosOpenExtractor::isMatch()
{
    return false;
}
