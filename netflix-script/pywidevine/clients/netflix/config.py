...
config = {
    ...
    'username': 'netflix@hitpaw.com',
    'password': 'Mqsw!K*S96JHSi',
    ...
    #'esn': 'NFANDROID2-PRV-SONYANDROIDTV2019VU-SONY=BRAVIA=VU1-12360-4AA5B5F40AB2A2AA17A38514CF4B2DBE1E9D4D84CD8658D5DCC0430D4E93A05C',    
     'esn': 'NFCDCH-02-J61WWEAKAL4V4X9TGFWFVHD0DA04AF',
...
MANIFEST_ENDPOINT = "https://www.netflix.com/msl/playapi/cadmium/licensedmanifest/1?reqAttempt=1&reqName=prefetch/licensedManifest&clienttype=akira&uiversion=v422d49b0&browsername=edgeoss&browserversion=86.0.622&osname=windows&osversion=10.0"
